...
Transactions are the core records. Support income, expense, create, edit, delete, category selection, account selection, note, date, source, and draft conversion.
