# Feature: Notification Parser Mybca

## Purpose

myBCA parser accepts only Catatan Finansial notifications containing Pengeluaran sebesar IDR or Pemasukan sebesar IDR, extracts amount and creates pending draft.
